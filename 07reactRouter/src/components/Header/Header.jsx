                    ...
                    >
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink
                                to="/"
                                // this isactive property is used to check that particular page is active or not means navlink you clicked and page you are on is same? if yes then orange or gray.
                                    className={({isActive}) =>
